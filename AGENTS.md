...
Vitest) → `README_5_playwright.md` (e2e tests with Playwright, against MSW). Next: Part 6
(`README_6_backend.md`, real backend). The user executes it manually, step by step.
<!-- /checkpoint:pointer -->
